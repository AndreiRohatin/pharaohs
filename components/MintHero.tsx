  ...
  return (
    <Box width="100%">
      <Text
        ...
        mb={5}
      >
      Be one of the greatest Pharaoh of ancient Egypt! 
      </Text>
      <Text
        as="h2"
        fontSize="lg"
        ...
        textAlign={{ base: 'center', md: 'left' }}
      >
      The Pharaohs ruled one of the most powerful and influential civilizations in the world for over 3,000 years. It left behind numerous monuments, documents and works of art that continue to be studied and inspire even today like this project.The rich history of ancient Egypt involves power struggle, amazing feats of engineering and much more.
      </Text>
      {!mintingPaused ? (
        <Box mt={6}>
          <NFTLeftToMint
